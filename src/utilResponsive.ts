import { IDeviceInfo, IWindowDimension } from "./IResponsive";
...
export const getDeviceTypeInfo = (windowDimension = getWindowDimension()): IDeviceInfo => {
	const { width, height }: IWindowDimension = windowDimension
...
const handleExceptions = (buildDeviceDetails: IDeviceInfo, width: number, height: number): IDeviceInfo | undefined => {
	//  iPadPro
